...
# 1 "C:/Users/victor/.mchp_packs/Microchip/PIC18F-K_DFP/1.5.114/xc8\\pic\\include\\__null.h" 1 3
...
# 126 "./mcc_generated_files/ccp1.h"
void CCP1_Initialize(void);
# 153 "./mcc_generated_files/ccp1.h"
void CCP1_SetCompareCount(uint16_t compareCount);
# 185 "./mcc_generated_files/ccp1.h"
_Bool CCP1_OutputStatusGet(void);
# 214 "./mcc_generated_files/ccp1.h"
...
motor motors[] = {{&PWM5_LoadDutyValue, (uint16_t) 740},
{&PWM6_LoadDutyValue, (uint16_t) 740}, {&PWM7_LoadDutyValue, (uint16_t) 740},
{&PWM8_LoadDutyValue, (uint16_t) 740}};
...
void check_comm(){
        ...
        if((conf & (1<<3 | 2 | 1)) < (1<<3 | 2 | 1)){
             setuptrans(3,0b11, 60, 1<<3|0b110|1, 10, 0);
        }
...
# 182 "main.c"
       ...
       if(drive == REMOTE){
        ...
        }else if (read(0x30) & 128 && drive == HOVER) {
           read_axises(axises);
           hover(hold, axises);
        } else if (drive == COMERR) {
            setuptrans(3,0b11, 60, 1<<3|0b110, 10, 0 );
        }
